          ...
          <>
            ...
            <button
              onClick={() => {
                ...
                if (!next) {
                  // retour au mode normal : on garde la quantité nette calculée
                  setGrossWeight("")
                  setWasteWeight("")
                }
              }}
              ...
              <div style={{ marginBottom: 14 }}>
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                      <div style={{
                        ...
                        {(() => {
                          const net = (parseFloat(grossWeight) || 0) - (parseFloat(wasteWeight) || 0)
                ...
                {!grossWeight && (
                  <div style={{ fontSize: 12, color: 'var(--text-hint)', fontStyle: 'italic' }}>
                    Pèse d'abord l'aliment entier, puis reviens peser le déchet.
                  </div>
                )}
                {grossWeight && !wasteWeight && (
                  <div style={{ fontSize: 12, color: 'var(--amber)', fontStyle: 'italic' }}>
                    ✓ Poids brut noté. Va peser le déchet, puis reviens ici.
                  </div>
                )}
              </div>
            ) : (
