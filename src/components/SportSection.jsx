...
// ─────────────────────────────────────────────────────────────────────────────
// SportSection — carte « Activité » de la page du jour. Version épurée : même
// esprit que WaterSection (section repliable, état en localStorage, un appui
// pour ajouter). Ne contient plus que :
//   • l'en-tête (titre + progression hebdo : sous-titre « X / Y min · Z % » +
//     barre fine, quand un objectif de minutes est réglé) ;
//   • une ligne compacte « pas du jour » si afficher_pas ;
//   • la liste des séances du jour.
// Le bilan énergétique / « manger selon l'effort » a été déplacé sous l'anneau
// de calories (TodayOverviewCard + SportEnergySheet) — plus rien ici.
//
// Props :
...
// ─────────────────────────────────────────────────────────────────────────────
export default function SportSection({ activites = [], week, sportCfg, pasJour, onOpenSheet, onOpenEntry, onOpenPas, onShareWeek }) {
  ...
  // Pas du jour (Palier 10) — ligne compacte, affichée si afficher_pas.
        ...
        <>
          ...
          <div style={{ padding: '10px 14px 12px' }}>
            ...
            {hasEntries ? (
              ...
              <div style={{ fontSize: 12.5, color: 'var(--text-muted)', lineHeight: 1.5, marginTop: showPas ? 10 : 0 }}>
                Aucune séance notée pour ce jour.
              </div>
            )}

            {(!hasEntries || (onShareWeek && week?.seances > 0)) && (
