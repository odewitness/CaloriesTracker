...
import { Droplet, Plus, ChevronRight, RotateCcw } from 'lucide-react'
...
// sa propre section. Ici, l'accent est mis sur l'ajout en UN appui : la jauge
// se remplit avec une animation à chaque portion ajoutée.
//
// Props :
  ...
  return (
    <div style={{ marginTop: 20 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 8 }}>
        ...
        <span className="section-title" style={{ margin: 0, color: 'var(--blue)' }}>Eau</span>
        {hasEntries && (
          <span style={{
        ...
        <span style={{ marginLeft: 'auto', display: 'inline-flex', alignItems: 'baseline', gap: 3 }}>
          <span style={{ fontSize: 14, fontWeight: 700, color: 'var(--text)' }}>{litres(totalMl)} L</span>
          <span style={{ fontSize: 12, color: 'var(--text-hint)' }}>/ {litres(goalMl)} L</span>
        </span>
        <button
          onClick={onOpenSheet}
          className="btn-icon"
